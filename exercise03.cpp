...
int main()
{
    ...
    Solution s{solveODE([](const std::vector<double> &initialValue, double initialTime, double h){return rk4Step(predatorPreyEQ, initialValue, initialTime, h);}, t0, t_end, T0, h)};//solveODE([](double T)
